  ...
  <body>
    <div class="container">
      ...
      <div class="body">
        ...
        <!-- Additional Info -->
        <p class="message">
          Se você não solicitou uma redefinição de senha, pode ignorar este e-mail com segurança. Sua conta permanecerá protegida.
        </p>
      </div>
      <!-- Footer -->
      <div class="footer">
